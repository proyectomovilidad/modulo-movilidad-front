...
const appRoutes: Routes = [
  ...
  {path: 'profesores', component:ProfesoresComponent, data: { roles: [1,5]}},
  {path: 'convenios', component:ConveniosComponent, data: { roles: [1, 2, 3, 5]}},
  {path: 'convocatoria', component:ConvocatoriaComponent, data: {roles: [1,2,3, 4, 5]}},
